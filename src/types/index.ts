...
export type ProgrammeImport = {
  ...
  startDate?: string
  endDate?: string
  schoolDetails?: { id: string; schoolName: string; programmeName: string; purchaseType: 'bargain' | 'super' | 'outdoor'; arrivalDate: string; departureDate: string; notes: string; groupNumbers?: number[] }[]
}
